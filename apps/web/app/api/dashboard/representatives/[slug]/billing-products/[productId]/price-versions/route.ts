import { publishOwnerBillingPriceVersion } from "@delegate/web-data";
...
export async function POST(
  ...
  try {
    ...
    const product = await publishOwnerBillingPriceVersion({
      ownerId: session.ownerId,
      representativeSlug: slug,
      productId,
      ...requestMetadata,
      priceVersion: await request.json().catch(() => null),
    });
