...
const copy = {
  zh: {
    ...
    heroCopy: "这里先给 owner 看清楚余额和流向：哪些 token 还没用，哪些收益待释放，哪些钱已经可以申请提现。当前提现是 WithdrawRequest 冻结和审核队列，不会自动打款。",
  ...
  en: {
    ...
    heroCopy: "This view gives owners the money picture first: unused tokens, pending earnings, withdrawable balance, and payout review. Withdrawals are currently request-and-freeze only; no automatic payout is sent.",
    revenueShare: (bps: number) => `Creator ${bps / 100}%`,
    cards: {
