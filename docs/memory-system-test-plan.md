...
建立 2 个代表、每个代表 2 个联系人、Web/Matrix/Telegram 三渠道，共 12 个会话单元，并执行全量交叉查询。
...
- 对账能发现并安全处理缺失、孤儿、哈希不一致和旧 active pointer。
...
- Web、Matrix、Telegram 首次发送前展示真实的记忆范围、保留期限和删除方式。
