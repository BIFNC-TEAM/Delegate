    ...
    const assembled = assembleRepresentativeReplyPrompt(
      {
        ...
        plan: {
          ...
          goal: "get_information",
          disposition: "answer",
          actions: [{ id: "answer_public_information:pricing", kind: "answer_public_information", status: "planned", sideEffect: "none" }],
  ...
  it("keeps public knowledge out of a recalled-context-only handoff while allowing contact memory", () => {
    const assembled = assembleRepresentativeReplyPrompt({
      ...
      plan: {
        ...
        goal: "request_human",
        disposition: "handoff",
        actions: [{ id: "request_human_handoff:handoff", kind: "request_human_handoff", status: "planned", sideEffect: "human_queue" }],
