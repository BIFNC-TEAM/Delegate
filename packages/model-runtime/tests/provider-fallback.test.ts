...
describe("provider fallback", () => {
  ...
  it("rejects invented task approval and paid-plan claims in an ordinary answer", async () => {
    const answerPlan = {
      ...
      goal: "get_information" as const,
      disposition: "answer" as const,
      actions: [{ id: "answer_public_information:faq", kind: "answer_public_information" as const, status: "planned" as const, sideEffect: "none" as const }],
      reasons: ["Public answer allowed."],
      responseOutline: ["Answer directly."],
    };
